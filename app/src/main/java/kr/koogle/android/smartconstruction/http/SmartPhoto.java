...
public class SmartPhoto implements Parcelable{
    ...
    public static final Parcelable.Creator CREATOR = new Parcelable.Creator() {
        ...
        @Override
        public SmartPhoto createFromParcel(Parcel in) {
            return new SmartPhoto(in);
        }

        @Override
        public SmartPhoto[] newArray(int size) {
            // TODO Auto-generated method stub
            return new SmartPhoto[size];
        }
