...
public class SmartWorkAdapter extends RecyclerView.Adapter<SmartWorkAdapter.ViewHolder> {
    // Store a member variable for the smartWorks
    private static ArrayList<SmartWork> mSmartWorks; // SmartSingleton.smartWorks -> smartWorks 변경 사용할 경우 !!
    // Store the context for easy access
    private Context mContext;

    // Pass in the smartWork array into the constructor
    ...
    @Override
    public SmartWorkAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(SmartWorkAdapter.ViewHolder viewHolder, int position) {
        ...
        /*
        tvName.setText(smartWork.strName);
        tvPeriod.setText(smartWork.strStartDate + " ~ " + smartWork.strEndDate);
        tvAddress.setText(smartWork.strAddress);
        tvSize.setText("지상 " + smartWork.intWorkGround + "층 , 지하 " + smartWork.intWorkBasement + "층");
        tvArea.setText(smartWork.strWorkArea11 + " 제곱미터");
...
*/
        ...
        public void onClick(View view) {
            ...
            Toast.makeText(context, smartWork.strName, Toast.LENGTH_LONG).show();
        }
        */
    }
